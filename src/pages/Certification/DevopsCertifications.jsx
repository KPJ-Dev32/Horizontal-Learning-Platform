...
const DevopsCertifications = () => {
  ...
  const ALL_CERTS = [
    { id: 1, title: 'Docker Certified Associate (DCA)' },
    { id: 2, title: 'Certified Kubernetes Administrator (CKA)' },
    { id: 3, title: 'AWS Certified DevOps Engineer - Professional' },
    { id: 4, title: 'Jenkins CI/CD Pipeline & Automation Specialist' },
    { id: 5, title: 'Terraform Infrastructure as Code (IaC) Expert' },
    { id: 6, title: 'Azure DevOps Professional Certification' },
    { id: 7, title: 'Google Cloud DevOps Engineer - Professional Track' },
    { id: 8, title: 'Site Reliability Engineering (SRE) Masterclass' },
    { id: 9, title: 'Ansible & Puppet Systems Automation Certificate' },
    { id: 10, title: 'Monitoring & Observability with Prometheus & Grafana' }
  ];
          ...
          <div className={styles.centeredContainer}>
            <div className={styles.breadcrumbWrapper}>
              <div className={styles.breadcrumb}>
                ...
                <span className={styles.linkActive}>DevOps Certifications</span>
              </div>
            </div>
            <h2 className={styles.pageTitle}>DevOps Certifications</h2>
...
export default DevopsCertifications;
