...
const DevopsSolutions = () => {
  ...
  const TAGS = ['All', 'Docker', 'K8s', 'AWS', 'CI/CD', 'Terraform'];
  const ALL_COURSES = [
    { id: 1, title: 'Docker for Beginners', desc: "Go from zero to hero with containerization using Docker.", duration: '50min', tags: ['Docker'] },
    { id: 2, title: 'Kubernetes in Practice', desc: "Learn to orchestrate containers at scale with K8s.", duration: '90min', tags: ['K8s'] },
    { id: 3, title: 'AWS Cloud Fundamentals', desc: "Master the basics of Amazon Web Services and its core services.", duration: '120min', tags: ['AWS'] },
    { id: 4, title: 'CI/CD with Jenkins & GitHub Actions', desc: "Automate your deployments and build pipelines.", duration: '75min', tags: ['CI/CD'] },
    { id: 5, title: 'Infrastructure as Code (Terraform)', desc: "Provision and manage any cloud infrastructure using Terraform.", duration: '65min', tags: ['Terraform'] }
  ];
    ...
    <div className={styles.wrapper}>
      ...
      <main className={styles.mainContent}>
        <section className={styles.heroSection} style={{ backgroundImage: `url("${heroBg}")` }}>
          <div className={styles.heroOverlay}><div className={styles.heroContainer}><h1 className={styles.heroTitle}>DevOps Solutions</h1></div></div>
        </section>
          ...
          <div className={styles.centeredContainer}>
            <div className={styles.breadcrumbWrapper}>
              <div className={styles.breadcrumb}>
                ...
                <span className={styles.linkActive}>DevOps Solutions</span>
              </div>
            </div>
            <h2 className={styles.pageTitle}>DevOps Training Courses</h2>
