...
const BackendSolutions = () => {
  ...
  const TAGS = ['All', 'Python', 'Node.js', 'Java', 'SQL', 'MongoDB'];
  const ALL_COURSES = [
    { id: 1, title: 'Python Backend Fundamentals', desc: "Learn the basics of server-side programming using Python and Flask.", duration: '60min', tags: ['Python'] },
    { id: 2, title: 'Node.js APIs with Express', desc: "Build scalable and high-performance REST APIs using Node.js.", duration: '45min', tags: ['Node.js'] },
    { id: 3, title: 'Java Spring Boot Core', desc: "Comprehensive guide to building enterprise-ready applications with Spring Boot.", duration: '120min', tags: ['Java'] },
    { id: 4, title: 'Relational Database Design (SQL)', desc: "Master SQL queries and database normalization for structured data.", duration: '75min', tags: ['SQL'] },
    { id: 5, title: 'NoSQL with MongoDB', desc: "Understand document-based databases and how to model data in MongoDB.", duration: '50min', tags: ['MongoDB'] },
    { id: 6, title: 'Django for Web Pros', desc: "Advanced Python web development using the Django framework.", duration: '90min', tags: ['Python'] },
    { id: 7, title: 'Microservices with Node.js', desc: "Learn to build and deploy microservice architectures using Node.", duration: '85min', tags: ['Node.js'] },
    { id: 8, title: 'Java Concurrency & Threads', desc: "Intermediate Java concepts for high-performance backend systems.", duration: '55min', tags: ['Java'] }
  ];
    ...
    <div className={styles.wrapper}>
      ...
      <main className={styles.mainContent}>
        <section className={styles.heroSection} style={{ backgroundImage: `url("${heroBg}")` }}>
          <div className={styles.heroOverlay}><div className={styles.heroContainer}><h1 className={styles.heroTitle}>Backend Solutions</h1></div></div>
        </section>
          ...
          <div className={styles.centeredContainer}>
            <div className={styles.breadcrumbWrapper}>
              <div className={styles.breadcrumb}>
                ...
                <span className={styles.linkActive}>Backend Solutions</span>
              </div>
            </div>
            <h2 className={styles.pageTitle}>Backend Training Courses</h2>
            ...
            <ul className={styles.courseList}>
              {paginatedCourses.map((course, i) => (
                <li key={course.id} className={styles.courseItem}>
                  ...
                  <div className={styles.courseMeta}><span className={styles.courseDuration}>Duration - {course.duration}</span><Button className={styles.learnMoreBtn} onClick={() => navigate(`/course-details?id=backend-rest&title=${encodeURIComponent(course.title)}`)}>Learn more</Button></div>
